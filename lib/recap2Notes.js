...
const TYPES = ['vente', 'non_reconduit'];
...
function enregistrer(db, { mois, studio, type, client, idClient = '', remarque, par = '', maintenant = new Date() } = {}) {
...
function ligneDe(rapport, { studio, type, client, idClient }) {
