...
function appliquer(rapport, controles) {
  ...
  Object.keys(copie.studios).forEach((s) => {
    ...
    cr.liste.forEach((l) => {
      ...
      // La résiliation n'a de sens que sur une vente retrouvée non annulée.
      // Une marque restée en base sur une ligne qui ne l'est plus (rapprochement
      // retiré, vente annulée ensuite dans FB) n'est pas affichée — elle
      // n'est pas effacée non plus : rien ne se perd.
      const eligible = l.retrouve === true && !l.annulee;
