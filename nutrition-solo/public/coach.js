...
function rendreFiche(b) {
  ...
  $('#ecFiche').innerHTML =
    ...
    // Zone centrale réservée au rendez-vous. Elle dit ce qui vient, sans le simuler.
    '<div class="ec-rdv">' +
      '<p class="ec-rdv-t">Rendez-vous — Étape ' + etape + '/' + b.etapesTotal + '</p>' +
      '<p class="ec-rdv-p">Le contenu de l\'Étape ' + etape + ' sera disponible dans la prochaine brique.</p>' +
    '</div>' +
