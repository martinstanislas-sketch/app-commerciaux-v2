...
(function (root, factory) {
  ...
  function rendreTexte(liste, meta) {
    const lignes = [];
    // Le moteur reste générique : le nom de l'app lui est FOURNI par l'appelant
    // (meta.programme) plutôt qu'écrit en dur ici. Rebrander ne touche donc
    // qu'un endroit, côté app.
    lignes.push('Liste de courses' + (meta && meta.programme ? ' — ' + meta.programme : ''));
